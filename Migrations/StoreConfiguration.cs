namespace BabyShop.Migrations.StoreConfiguration
{
    ...
    internal sealed class StoreConfiguration : DbMigrationsConfiguration<BabyShop.DAL.StoreContext>
    {
        ...
        protected override void Seed(BabyShop.DAL.StoreContext context)
        {
